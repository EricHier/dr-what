<template>
  <div class="px-8 py-10 w-full animated fadeIn faster">
    <div class="container mx-auto">
      ...
      <h2 class="mt-8 text-2xl font-bold">Angaben gemäß 5 TMG</h2>
      <p class="mt-4">
        Eric Feltgen<br/>
        Heerlenerstr. 16<br/>
        52074 Aachen
      ...
      <p class="mt-4">
        Telefon: 0241 55705543<br/>
        E-Mail: developer.erichier@gmail.com
      </p>

      <h3 class="mt-8 text-2xl font-bold">Haftung f&uuml;r Inhalte</h3>
      <p class="mt-4">
      ...
      <h3 class="mt-8 text-2xl font-bold">Haftung f&uuml;r Links</h3>
      <p class="mt-4">
      ...
      <h3 class="mt-8 text-2xl font-bold">Urheberrecht</h3>
      <p class="mt-4">
